...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    if(isset($_POST['snoEdit'])){
      ...
      if($result){
        ...
        "Record was not updated sucessfully";
      }
    }
   else
  {
    ...
    if($result){
      // echo "The record has been sucessfully inserted ";
      $insert = true ;
    }
    else
    {
...
<!-- INSERT INTO `notes` (`srno`, `title`, `description`, `tsamp`) VALUES ('', 'bye books', 'please bye books from store ', current_timestamp()); -->